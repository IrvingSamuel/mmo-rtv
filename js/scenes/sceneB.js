var SceneB = new Phaser.Class({
    ...
    create: function(){
        ...
        bg = this.physics.add.staticImage(midw, midh, "mapa1");
        limits1 = this.physics.add.staticImage(midw, midh, "limits1");
        roofs = this.physics.add.staticImage(midw, midh, "roofs1").setDepth(1920);
        ...
        limitsTopLeft = limits1.getTopLeft();
